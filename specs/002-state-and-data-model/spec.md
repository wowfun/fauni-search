...
- 当前切片跨 restart 恢复的最小 durable truth 固定为：`libraries`、`library_configs`、`library_source_roots`、`library_source_root_rules`、`sources`、`visual_units` 与 `active_index_references`
