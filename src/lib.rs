...
pub(crate) const RETIRED_VECTOR_SPACE_REAPER_INTERVAL_SECS: u64 = 60;
...
pub(crate) const ACTIVE_INDEX_VISIBILITY: &str = "active";
pub(crate) const RETIRED_INDEX_VISIBILITY: &str = "retired";
