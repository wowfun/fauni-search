...
export const state: AppState = {
  ...
  globalContentTypeOrigins: {},
  libraryContentTypes: emptyContentTypes(),
  libraryContentTypeOrigins: {},
  ...
  editingProviderId: "",
  providerDisplayNameDraft: "",
  providerKindDraft: "",
  providerEnabledDraft: true,
  providerBaseUrlDraft: "",
  providerActiveModelDraft: "",
  editingProviderModelId: "",
  providerModelIdDraft: "",
  providerModelEnabledDraft: true,
  providerModelVersionDraft: "main",
  providerModelBackendDraft: "",
  providerModelInputTypesDraft: "text, image",
  providerModelVectorTypesDraft: "single_vector",
  providerModelSupportsMixedInputsDraft: false,
